...
export function FilterBottomSheetModal({
  ...
  }, [backdropOpacity, isMounted, requestClose, translateY, visible]);
          ...
          >
            ...
            <View
              style={{
                ...
                paddingBottom: theme.spacing.screenPaddingVertical + insets.bottom,
                gap: theme.spacing.md,
              }}
            >
              <Button title="Сбросить" variant="secondary" onPress={onReset} style={{ flex: 1, borderWidth: 0 }} />
              <Button title="Применить" variant="primary" onPress={onApply} style={{ flex: 1.6 }} />
            </View>
          </Animated.View>
        </View>
      </View>
