...
export const mockActivityRecords: ActivityRecord[] = [
  {
    ...
    location: {
      latitude: 55.833,
      longitude: 37.618,
      address: 'Проспект Мира, 119, стр.23',
      name: 'Клуб «Море музыки»',
      settlement: 'Москва',
      region: 'Москва',
      country: 'Россия',
    },
    startAt: buildFixedTimes('2026-05-14T19:00:00+03:00', '2026-05-14T20:30:00+03:00').start.toISOString(),
    endAt: buildFixedTimes('2026-05-14T19:00:00+03:00', '2026-05-14T20:30:00+03:00').end.toISOString(),
...

  {
    ...
    location: {
      latitude: 55.761,
      longitude: 37.663,
      address: 'Нижний Сусальный переулок, 5, стр.1',
      name: 'Кофейня «Место»',
      settlement: 'Москва',
      region: 'Москва',
      country: 'Россия',
    },
    startAt: buildFixedTimes('2026-05-15T18:30:00+03:00', '2026-05-15T20:30:00+03:00').start.toISOString(),
    endAt: buildFixedTimes('2026-05-15T18:30:00+03:00', '2026-05-15T20:30:00+03:00').end.toISOString(),
    timeZone: 'Europe/Moscow',
    preferences: {
      level: 'intermediate',
      maxParticipants: 10,
...

  {
    ...
    startAt: buildFixedTimes('2026-05-17T11:00:00+03:00', '2026-05-17T13:00:00+03:00').start.toISOString(),
    endAt: buildFixedTimes('2026-05-17T11:00:00+03:00', '2026-05-17T13:00:00+03:00').end.toISOString(),
    timeZone: 'Europe/Moscow',
    preferences: {
      ageFrom: 20,
      ageTo: 40,
...

  {
    ...
    startAt: buildFixedTimes('2026-05-18T08:00:00+03:00', '2026-05-18T09:00:00+03:00').start.toISOString(),
    endAt: buildFixedTimes('2026-05-18T08:00:00+03:00', '2026-05-18T09:00:00+03:00').end.toISOString(),
    timeZone: 'Europe/Moscow',
    preferences: {
      level: 'beginner',
      maxParticipants: 0,
